...
class InformationOverview extends Template
{
    protected $_template = 'BroCode_AmqpMonitor::information_overview.phtml';
    /**
    ...
    public function getInformationOverview() {
        return $this->managementApiService->getInformationOverview();
    }
}